...
INSERT_STRONGHOLD_RETURN_ID = (    
    "INSERT INTO strongholds (user_id, stronghold_name, stronghold_level, stronghold_type_id, stronghold_subtype_id, stronghold_class_id, class_feature_uses, created_at) VALUES (%s, %s, %s, %s, %s, %s, %s, %s) RETURNING id;"
)

GET_ALL_STRONGHOLDS_BY_USER = (
    "SELECT stronghold_name, stronghold_level, stronghold_type_id, stronghold_class_id"
)
