...
from controllers.strongholdConstructionLevelsController import create_stronghold_construction_levels_table, populate_stronghold_construction_levels_table, insert_new_stronghold_construction_level, get_all_stronghold_construction_levels, get_stronghold_construction_by_level, get_stronghold_construction_levels_by_type_id, update_stronghold_construction_level_by_id, delete_stronghold_construction_level_by_id, clear_stronghold_construction_levels_table
...
@stronghold_construction_levels_bp.route("/populate", methods=["POST"])
def populate_stronghold_construction_levels_table_route():
    return populate_stronghold_construction_levels_table()
...
@stronghold_construction_levels_bp.route("/clear", methods=["DELETE"])
def clear_stronghold_construction_levels_table_route():
    return clear_stronghold_construction_levels_table()